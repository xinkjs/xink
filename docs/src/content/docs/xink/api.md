...
You can pass a configuration object when creating the new instance. All constructor options are optional.
```ts
{
  ...
  check_origin?: boolean; // deprecated; use allowed_origins; default true
}
```
